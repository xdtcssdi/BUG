...
def load_data(path):
    ...
    train_set_x_orig = p.array(train_dataset["train_set_x"][:])  # your train set features
    train_set_y_orig = p.array(train_dataset["train_set_y"][:])  # your train set labels

    test_dataset = h5py.File(path[1], "r")
    test_set_x_orig = p.array(test_dataset["test_set_x"][:])  # your test set features
    test_set_y_orig = p.array(test_dataset["test_set_y"][:])  # your test set labels

    classes = p.array(test_dataset["list_classes"][:])  # the list of classes
